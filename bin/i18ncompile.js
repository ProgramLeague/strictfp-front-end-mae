...
/* usage: ./compile_i18n.js <input_folder>
	Only one language in each input file supported.
*/
...
//read input files
var temp1 = fs.readdirSync(process.argv[2]), input_file = [];
for( var i = 0; i < temp1.length; i++ ) {
	if ( /-i18n.txt$/.test( temp1[i] ) ) input_file.push( process.argv[2] + "/" + temp1[i] );
}
...
process.stdout.write( JSON.stringify(parsed_data), "utf-8" );